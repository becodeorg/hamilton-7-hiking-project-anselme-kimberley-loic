<div class="w-full p-6">
    <div class="flex w-6/12 mr-auto ml-auto justify-between mb-6">
        <a href="/updatehike?code=<?= $hike['hid']; ?>"><img class="w-6 mr-4" src="assets/images/edit-svgrepo-com.svg"></a>
        <a href="/deletehike?code=<?= $hike['hid']; ?>"><img class="w-6" src="assets/images/delete-svgrepo-com.svg"></a>
    </div>
